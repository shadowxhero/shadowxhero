...
window.K4G_EXTERNAL_DICT = {
  ...
  "Below you’ll find a quick overview of ": '以下是',
  'upcoming product releases scheduled for this week': '本周即将发布的产品',
  ...
  'The customer received a refund': '客户已收到退款',
  'Could you please speed up delivery time': '能否请您加快交付速度',
  'Issue type': '问题类型',
  'Non delivery': '未交付',
